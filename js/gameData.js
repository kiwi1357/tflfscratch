...
const gameData = {
    ...
    items: {
        "driftwood": { name: "Driftwood", description: "A sturdy piece of wood, worn smooth by the water." },
        "sugar": { name: "Sugar", description: "A bag of 'sugar'... an ingredient Scarlett's never been out of in her entire life!" },
        "lost_book": { name: "Lost Book", description: "An old, leather-bound book titled 'A Brief History of the Valley'."}
    },
